...
?>
<?php $homeslides .= '{image : \''.$image_url[0].'\', thumb: \''.$small_image_url[0].'\', title: \'<div id="gallery_caption"><h2>'.addslashes($image_caption).'</h2><div class="gallery_desc">'.addslashes(trim(preg_replace('/\s+/', ' ', $image_desc))).'</div></div>\'},'; ?>
<?php
	}
?>
