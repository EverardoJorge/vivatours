...
?>
					    ...
					    <div class="<?php echo esc_attr($tour_block_class); ?> last">
					    	<a id="tour_book_btn" <?php if(!empty($tour_booking_url)) { ?>href="<?php echo $tour_booking_url; ?>"<?php }?> class="button center"><?php echo _e( 'RESERVAR', THEMEDOMAIN ); ?></a>
					    </div>
					</div>
				</div>
			<?php
		    	...
		    	?>
			    	<div class="tour_call_to_action parallax" <?php if(!empty($pp_page_bg)) { ?>style="background-image:url('<?php echo $pp_page_bg; ?>');"<?php } ?>>
						...
						<div class="tour_call_to_action_box">
							...
							<a id="call_to_action_tour_book_btn" <?php if(!empty($tour_booking_url)) { ?>href="<?php echo $tour_booking_url; ?>"<?php }?> class="button"><?php echo _e( 'RESERVAR', THEMEDOMAIN ); ?></a>
						</div>
			    	</div>
		    	<?php
		    		}
