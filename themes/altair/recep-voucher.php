 ...
 */
/**
 * Template Name: Voucher Receptivo
...
$query = $wpdb->get_results("SELECT * FROM vvt_voucher_recep WHERE idvoucher='".$_GET[folio]."'", ARRAY_A );
$datos= $wpdb->num_rows;
 $folio=$_GET[folio];
...
<?php
function dameURL(){
$url1="https://".$_SERVER['HTTP_HOST']."/wp-content/plugins/recep-voucher/";
return $url1;
}
$url1= dameURL();
?>
...
if (j_accion=="solograba") j_mensaje="Confirma la actualización de los datos del Voucher No. <?php= sprintf("%08d",$_GET[folio]) ?>?"
if (j_accion=="duplicar") j_mensaje="Confirma que desea DUPLICAR la información del folio <?php= sprintf("%08d",$_GET[folio]) ?> en uno nuevo?"
if (j_accion=="PDF") j_mensaje="Confirma que desea generar nuevamente el archivo PDF para este Voucher?"
if (j_accion=="cancelar") j_mensaje="Confirma que desea CANCELAR el Voucher No. <?php= sprintf("%08d",$_GET[folio]) ?>?"
...
if (confirm(j_mensaje))
	{
	document.form1.action="<?php=$url1?>voucher_actualizar.php"
...
<div style="background:url(<?php=$query[0]["folio"]=="CANCELADO"?"".$url1."images/cancelado.gif":''?>)">
<form action="#" method="post" id="form1" name="form1"  enctype="multipart/form-data">
<input type="hidden" name="accion" id="accion" />
<input type="hidden" name="URLretorno" id="URLretorno" value="<?php=$_GET[URLretorno]?>">
<input type="hidden" name="folio" id="folio" value="<?php=$_GET[folio]?>" />
   <table width="90%" border="1" align="center" cellpadding="0" cellspacing="0" rules="none" class="table table-hover table-condensed">
    <tr>
      <td width="27%" align="center" valign="middle" class="logo_voucher"><img src="<?php=$url1?>images/voucher_logo.png" width="180px" height="80px" /></td>
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          <td height="50px" align="center"  class="folios_voucher" style="text-align:center; vertical-align:middle;"><?php //sprintf("%08d",$folio)?>
           <?php=$query[0]["folio"]=="CANCELADO"?'<font style="text-decoration:line-through;">'. sprintf("%08d",$folio).'</font>':''.sprintf("%08d",$folio).''?></td>
        </tr>
      </table></td>
    </tr>
  </table>
  <table width="80%" border="0" align="center" cellpadding="0" cellspacing="0" class="table table-bordered table-hover table-condensed">
    <tr>
      ...
      <table width="220px" border="1" align="left" cellpadding="0" cellspacing="0" rules="none" class="table table-bordered table-hover table-condensed">
        ...
        <tr>
          <td class=""><input name="codigo1" type="text" id="codigo1" size="12" value="<?php=$query[0]["codigo1"]?>" /></td>
          <td class=""><input name="codigo2" type="text" id="codigo2" size="12" value="<?php=$query[0]["codigo2"]?>"  /></td>
        </tr>
      </table></td>
      ...
      <table width="350px" border="1" cellspacing="0" cellpadding="0" rules="none" class="table table-bordered table-hover table-condensed">
        ...
        <tr>
          <td  class=""><input name="codigo3" type="text" id="codigo3" size="50" value="<?php=$query[0][codigo3]?>" /></td>
        </tr>
      </table></td>
      ...
      <table  border="1" cellpadding="0" cellspacing="0" rules="none" class="table table-bordered table-hover table-condensed">
        ...
        <tr>
          ...
          <tr>
        <tr>
          <td class=""><input name="codigo14" type="text" class="input_voucher" id="codigo14" size="5" value="<?php=$query[0][codigo14]?>"/></td>
          <td class=""><input name="codigo4" type="text" class="input_voucher" id="codigo4" size="5" value="<?php=$query[0][codigo4]?>"/></td>
          <td class=""><input name="codigo5" type="text" class="input_voucher" id="codigo5" size="5" value="<?php=$query[0][codigo5]?>"/></td></tr><tr>
          <td  class="">SGL</td>
          <td  class="">OTHER</td>
          <td  class="">TOTAL PAX.</td>
          </tr>
          <td class=""><input name="codigo6" type="text" class="input_voucher" id="codigo6" size="5" value="<?php=$query[0][codigo6]?>"/></td>
          <td class=""><input name="codigo7" type="text" class="input_voucher" id="codigo7" size="5" value="<?php=$query[0][codigo7]?>"/></td>
          <td class=""><input name="codigo8" type="text" class="input_voucher" id="codigo8" size="5" value="<?php=$query[0][codigo8]?>"/></td>
          </tr>
          <tr>
            <td  colspan="6" align="center" class="">ESPECIFICACIONES / SPECIFICATIONS</td>
          </tr>
          <tr>
            <td  colspan="6" align="center"><input name="codigo15" type="text" id="codigo15" size="30" value="<?php=$query[0][codigo15]?>"></td>
          </tr>
      </table>
      ...
      <table width="242" border="1" align="center" cellpadding="0" cellspacing="1"  rules="none" class="table table-bordered table-hover table-condensed">
        ...
        <tr>
          <td class=""><input name="codigo12" type="text" id="codigo12" size="30" value="<?php=$query[0][codigo12]?>"></td>
        </tr>
            <tr>
            <td>
      ...
      <tr>
        <td class=""><input name="codigo13" type="text" id="codigo13" size="30" value="<?php=$query[0][codigo13]?>"></td>
        </tr>
    </table>            
            </td>
            </tr>
      ...
      <tr>
		...
		<img src="<?php=$url1?>qrcode/<?php=$folio?>.png">
		</td>
        </tr>
    </table>
    ...
    <tr>
      <td colspan="2" valign="top"><table width="569px" border="1" cellspacing="0" cellpadding="0" rules="none" class="table table-bordered table-hover table-condensed">
        ...
        <tr>
          <td class=""><input name="codigo9" type="text" id="codigo9" size="87" value="<?php=$query[0][codigo9]?>" /></td>
          </tr>
      </table></td>
    </tr>
    <tr>
      <td colspan="2" valign="top"><table width="569px" border="1" cellspacing="0" cellpadding="0"  rules="none">
        ...
        <tr>
          <td class="">
		  <input name="codigo10" type="text" id="codigo10" size="20" value="<?php=$query[0][codigo10]?>" />&nbsp;
          <input name="codigo11" type="text" id="codigo11" size="50" value="<?php=$query[0][codigo11]?>" />
		  </td>
          </tr>
      </table></td>
    </tr>
        ...
        <table width="569px" border="1" cellspacing="2" cellpadding="0"  rules="none" class="table table-bordered table-hover table-condensed">
          ...
          <tr>
            <td width="120px" valign="top" align="center" class="">
			  <input name="fechas" type="text" class="" id="fechas"  size="15" value="<?php=$query[0][fechas]?>" /><br />
              <input name="fechas2" type="text" class="" id="fechas2" size="15" value="<?php=$query[0][fechas2]?>" /><br />
              <input name="fechas3" type="text" class="" id="fechas3" size="15" value="<?php=$query[0][fechas3]?>" /><br />
              <input name="fechas4" type="text" class="" id="fechas4" size="15" value="<?php=$query[0][fechas4]?>" /><br />
              <input name="fechas5" type="text" class="" id="fechas5" size="15" value="<?php=$query[0][fechas5]?>" /><br />
              <input name="fechas6" type="text" class="" id="fechas6" size="15" value="<?php=$query[0][fechas6]?>" /><br />
              <input name="fechas7" type="text" class="" id="fechas7" size="15" value="<?php=$query[0][fechas7]?>" /><br />
              <input name="fechas8" type="text" class="" id="fechas8" size="15" value="<?php=$query[0][fechas8]?>" /><br /></td>
            <td width="437" align="left" class="" valign="top">
			  <input name="descripciones" type="text" class="" id="descripciones" value="<?php=$query[0][descripciones]?>" size="80" /><br />
              <input name="descripciones2" type="text" class="" id="descripciones2" value="<?php=$query[0][descripciones2]?>" size="80" /><br />
              <input name="descripciones3" type="text" class="" id="descripciones3" value="<?php=$query[0][descripciones3]?>" size="80" /><br />
              <input name="descripciones4" type="text" class="" id="descripciones4" value="<?php=$query[0][descripciones4]?>" size="80" /><br />
              <input name="descripciones5" type="text" class="" id="descripciones5" value="<?php=$query[0][descripciones5]?>" size="80" /><br />
              <input name="descripciones6" type="text" class="" id="descripciones6" value="<?php=$query[0][descripciones6]?>" size="80" /><br />
              <input name="descripciones7" type="text" class="" id="descripciones7" value="<?php=$query[0][descripciones7]?>" size="80" /><br />
              <input name="descripciones8" type="text" class="" id="descripciones8" value="<?php=$query[0][descripciones8]?>" size="80" /></td>
          </tr>
      </table></td>
    </tr>
  </table>
...
<table width="550%" border="0" align="center" cellpadding="0" cellspacing="0" class="table table-borderless table-hover table-condensed">
  <tr>
    <td width="100" align="center"><input type="button" name="button2" id="button2" value="<- Back" onClick="javascript:history.go(-1)"></td>
     <?php //if ($query[0][folio]!="CANCELADO") { ?>
    <td width="100" align="center">
<button type="button" class="button"  name="solograba" onClick="j_accion='solograba'; objetivo='_self'; valida();">Actualizar </button> </td>    
