    ...
    <div class="wpmudev-tabs">
        ...
        <ul class="wpmudev-tabs-menu wpmudev-tabs-menu_lg">
            ...
            <li class="wpmudev-tabs-menu_item">
                ...
                <label for="wph-wizard-disable-widget-customize-colors"><?php esc_attr_e( "Default colors", Opt_In::TEXT_DOMAIN ); ?></label>
            ...
            <li class="wpmudev-tabs-menu_item">
                ...
                <label for="wph-wizard-enable-widget-customize-colors"><?php esc_attr_e( "Custom colors", Opt_In::TEXT_DOMAIN ); ?></label>
