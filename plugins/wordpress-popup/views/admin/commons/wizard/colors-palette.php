<div id="wph-modal-palette" class="wpmudev-box-gray {{ ( _.isTrue(customize_colors) ) ? 'wpmudev-show' : 'wpmudev-hidden' }}">
	...
	<div class="wpmudev-row" style="z-index: 10;">
		...
		<div class="wpmudev-col col-12 col-xs-4 col-sm-12 col-lg-4">
			...
			<div class="wpmudev-picker" style="z-index: 2;"><input id="popup_image_background" class="wpmudev-color_picker" type="text"  value="{{ image_container_bg }}" data-attribute="image_container_bg" data-alpha="true" /></div>

		</div>

		<div class="wpmudev-col col-12 col-xs-4 col-sm-12 col-lg-4">

			<label><?php esc_attr_e( 'Form area BG', Opt_In::TEXT_DOMAIN ); ?></label>
	...
	<div class="wpmudev-row" style="z-index: 9;">
		...
		<div class="wpmudev-col col-12 col-xs-4 col-sm-12 col-lg-4">
			...
			<div class="wpmudev-picker" style="z-index: 3;"><input id="popup_title_color" class="wpmudev-color_picker" type="text"  value="{{ title_color }}" data-attribute="title_color" data-alpha="true" /></div>
		...
		<div class="wpmudev-col col-12 col-xs-4 col-sm-12 col-lg-4">
			...
			<div class="wpmudev-picker" style="z-index: 2;"><input id="popup_subtitle_color" class="wpmudev-color_picker" type="text"  value="{{subtitle_color}}" data-attribute="subtitle_color" data-alpha="true" /></div>
		...
		<div class="wpmudev-col col-12 col-xs-4 col-sm-12 col-lg-4">
			...
			<div class="wpmudev-picker" style="z-index: 1;"><input id="popup_content_color" class="wpmudev-color_picker" type="text"  value="{{content_color}}" data-attribute="content_color" data-alpha="true" /></div>
	...
	<div class="wpmudev-row" style="z-index: 8;">
		...
		<div class="wpmudev-col col-12 col-xs-4 col-sm-12 col-lg-4">
			...
			<label><?php esc_attr_e( 'CTA Button BG', Opt_In::TEXT_DOMAIN ); ?></label>
		...
		<div class="wpmudev-col col-12 col-xs-4 col-sm-12 col-lg-4">
			...
			<label><?php esc_attr_e( 'CTA Button color', Opt_In::TEXT_DOMAIN ); ?></label>
	...
	<div class="wpmudev-row" style="z-index: 7;">
		...
		<div class="wpmudev-col col-12 col-xs-4 col-sm-12 col-lg-4" style="z-index: 3;">
			...
			<div class="wpmudev-picker"><input id="popup_gdpr_content" class="wpmudev-color_picker" type="text"  value="{{ gdpr_content }}" data-attribute="gdpr_content" data-alpha="false" /></div>
		...
		<div class="wpmudev-col col-12 col-xs-4 col-sm-12 col-lg-4" style="z-index: 1;">
			...
			<div class="wpmudev-picker"><input id="popup_gdpr_checkbox_icon" class="wpmudev-color_picker" type="text"  value="{{ gdpr_checkbox_icon }}" data-attribute="gdpr_checkbox_icon" data-alpha="false" /></div>

		</div>

	</div>

	<h5><?php esc_attr_e( 'Opt In Form', Opt_In::TEXT_DOMAIN ); ?></h5>

	<div class="wpmudev-row" style="z-index: 6;">

		<div class="wpmudev-col col-12 col-xs-4 col-sm-12 col-lg-4">

			<label><?php esc_attr_e( 'Input field BG', Opt_In::TEXT_DOMAIN ); ?></label>
		...
		<div class="wpmudev-col col-12 col-xs-4 col-sm-12 col-lg-4">
			...
			<label><?php esc_attr_e( 'Input icon color', Opt_In::TEXT_DOMAIN ); ?></label>
		...
		<div class="wpmudev-col col-12 col-xs-4 col-sm-12 col-lg-4">
			...
			<label><?php esc_attr_e( 'Placeholder', Opt_In::TEXT_DOMAIN ); ?></label>
	...
	<div class="wpmudev-row" style="z-index: 5;">
		...
		<div class="wpmudev-col col-12 col-xs-4 col-sm-12 col-lg-4">
			...
			<label><?php esc_attr_e( 'Input field text', Opt_In::TEXT_DOMAIN ); ?></label>
		...
		<div class="wpmudev-col col-12 col-xs-4 col-sm-12 col-lg-4">
			...
			<label><?php esc_attr_e( 'Submit button BG', Opt_In::TEXT_DOMAIN ); ?></label>
		...
		<div class="wpmudev-col col-12 col-xs-4 col-sm-12 col-lg-4">
			...
			<label><?php esc_attr_e( 'Submit button color', Opt_In::TEXT_DOMAIN ); ?></label>
	...
	<div class="wpmudev-row" style="z-index: 4;">
		...
		<div class="wpmudev-col col-12 col-xs-4 col-sm-12 col-lg-4">
			...
			<label><?php esc_attr_e( 'Error text', Opt_In::TEXT_DOMAIN ); ?></label>
		...
		<div class="wpmudev-col col-12 col-xs-4 col-sm-12 col-lg-4">
			...
			<label><?php esc_attr_e( 'Error text BG', Opt_In::TEXT_DOMAIN ); ?></label>
	...
	<h5><?php esc_attr_e( 'Mailchimp Extras', Opt_In::TEXT_DOMAIN ); ?></h5>

	<div class="wpmudev-row" style="z-index: 3;">

		<div class="wpmudev-col col-12 col-xs-4 col-sm-12 col-lg-4">

			<label><?php esc_attr_e( 'Mailchimp title', Opt_In::TEXT_DOMAIN ); ?></label>
		...
		<div class="wpmudev-col col-12 col-xs-4 col-sm-12 col-lg-4">
			...
			<label><?php esc_attr_e( 'Mailchimp labels', Opt_In::TEXT_DOMAIN ); ?></label>
		...
		<div class="wpmudev-col col-12 col-xs-4 col-sm-12 col-lg-4">
			...
			<label><?php esc_attr_e( 'Check / Radio BG', Opt_In::TEXT_DOMAIN ); ?></label>
	...
	<div class="wpmudev-row" style="z-index: 3;">
		...
		<div class="wpmudev-col col-12">
			...
			<label><?php esc_attr_e( 'Check / Radio tick', Opt_In::TEXT_DOMAIN ); ?></label>
	...
	<div class="wpmudev-row" style="z-index: 2;">
		...
		<div class="wpmudev-col col-12 col-xs-4 col-sm-12 col-lg-4">
			...
			<label><?php esc_attr_e( 'Success tick', Opt_In::TEXT_DOMAIN ); ?></label>
		...
		<div class="wpmudev-col col-12 col-xs-4 col-sm-12 col-lg-4">
			...
			<label><?php esc_attr_e( 'Success content', Opt_In::TEXT_DOMAIN ); ?></label>
