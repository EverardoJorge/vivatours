<div id="wph-wizard-content-name" class="wpmudev-box-content">
	...
	<div class="wpmudev-box-right">
		...
		<label class="wpmudev-label--notice {{ ( _.isEmpty ( module_name ) ? '' : 'wpmudev-hidden' )  }}"><span><?php esc_attr_e( "Oops, you need to name your embed before you proceed.", Opt_In::TEXT_DOMAIN ); ?></span></label>
