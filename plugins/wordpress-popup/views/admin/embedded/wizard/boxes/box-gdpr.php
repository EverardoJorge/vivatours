	...
	<div class="wpmudev-box-right">
		...
		<div class="wpmudev-switch-labeled">
			...
			<div class="wpmudev-switch">
				...
				<input id="wph-embedded-gdpr-button" class="toggle-checkbox" type="checkbox" data-attribute="show_gdpr" {{_.checked(_.isTrue(show_gdpr), true)}}>
				
				<label class="wpmudev-switch-design" for="wph-embedded-gdpr-button" aria-hidden="true"></label>
				
			</div>
			
			<label class="wpmudev-switch-label" for="wph-embedded-gdpr-button"><?php _e( "Show GDPR Checkbox", Opt_In::TEXT_DOMAIN ); ?></label>
