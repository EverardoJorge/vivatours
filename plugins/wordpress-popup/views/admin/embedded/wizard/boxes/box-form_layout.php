	...
	<div class="wpmudev-box-right">
		...
		<div class="wpmudev-box-layouts">
			...
			<div class="wpmudev-box-layout_one {{ ( 'one' === form_layout ) ? 'active' : '' }}">
				...
				<div class="wpmudev-box-layout_svg" for="wph-aftercontent-layout_one">
				...
				<div class="wpmudev-input_radio">
                    ...
                    <input type="radio" id="wph-aftercontent-layout_one" name="form_layout" value="one" data-attribute="form_layout" {{_.checked( ( 'one' === form_layout ) , true)}}>

                    <label for="wph-aftercontent-layout_one" class="wpdui-fi wpdui-fi-check"></label>
			...
			<div class="wpmudev-box-layout_two {{ ( 'two' === form_layout ) ? 'active' : '' }}">
				...
				<div class="wpmudev-box-layout_svg" for="wph-aftercontent-layout_two">
				...
				<div class="wpmudev-input_radio">
                    ...
                    <input type="radio" id="wph-aftercontent-layout_two" name="form_layout" value="two" data-attribute="form_layout" {{_.checked( ( 'two' === form_layout ) , true)}}>

                    <label for="wph-aftercontent-layout_two" class="wpdui-fi wpdui-fi-check"></label>
			...
			<div class="wpmudev-box-layout_three {{ ( 'three' === form_layout ) ? 'active' : '' }}">
				...
				<div class="wpmudev-box-layout_svg" for="wph-aftercontent-layout_three">
				...
				<div class="wpmudev-input_radio">
                    ...
                    <input type="radio" id="wph-aftercontent-layout_three" name="form_layout" value="three" data-attribute="form_layout" {{_.checked( ( 'three' === form_layout ) , true)}}>

                    <label for="wph-aftercontent-layout_three" class="wpdui-fi wpdui-fi-check"></label>
			...
			<div class="wpmudev-box-layout_four {{ ( 'four' === form_layout ) ? 'active' : '' }}">
				...
				<div class="wpmudev-box-layout_svg" for="wph-aftercontent-layout_four">
				...
				<div class="wpmudev-input_radio">
                    ...
                    <input type="radio" id="wph-aftercontent-layout_four" name="form_layout" value="four" data-attribute="form_layout" {{_.checked( ( 'four' === form_layout ) , true)}}>

                    <label for="wph-aftercontent-layout_four" class="wpdui-fi wpdui-fi-check"></label>
