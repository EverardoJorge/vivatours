<div id="wph-wizard-design-palette" class="wpmudev-box-content">
	...
	<div class="wpmudev-box-left">
		...
		<label class="wpmudev-helper"><?php esc_attr_e( "Choose a pre-made palette for your Pop-up and further customize its appearance.", Opt_In::TEXT_DOMAIN ); ?></label>
	...
	<div class="wpmudev-box-right">
		...
		<div class="wpmudev-switch-labeled">
			...
			<div class="wpmudev-switch">
				...
				<input id="wph-popup-custom_palette" class="toggle-checkbox" type="checkbox" data-attribute="customize_colors" {{ _.checked( _.isTrue( customize_colors ), true ) }}>

				<label class="wpmudev-switch-design" for="wph-popup-custom_palette" aria-hidden="true"></label>

			</div>

			<label class="wpmudev-switch-label" for="wph-popup-custom_palette"><?php esc_attr_e( 'Customize colors', Opt_In::TEXT_DOMAIN ); ?></label>
