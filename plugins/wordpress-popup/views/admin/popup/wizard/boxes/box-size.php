<div id="wph-wizard-design-size" class="wpmudev-box-content">
	...
	<div class="wpmudev-box-left">
		...
		<h4><strong><?php esc_attr_e( "Custom pop-up size", Opt_In::TEXT_DOMAIN ); ?></strong></h4>
	...
	<div class="wpmudev-box-right">
		...
		<div class="wpmudev-switch-labeled">
			...
			<div class="wpmudev-switch">
				...
				<input id="wph-popup-custom_size" class="toggle-checkbox" type="checkbox" data-attribute="customize_size" {{_.checked(_.isTrue(customize_size), true)}}>

				<label class="wpmudev-switch-design" for="wph-popup-custom_size" aria-hidden="true"></label>

			</div>

			<label class="wpmudev-switch-label" for="wph-popup-custom_size"><?php esc_attr_e( "Use custom size", Opt_In::TEXT_DOMAIN ); ?></label>
