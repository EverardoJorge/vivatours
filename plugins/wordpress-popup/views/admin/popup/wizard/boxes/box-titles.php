<div id="wph-wizard-content-titles" class="wpmudev-box-content">
	...
	<div class="wpmudev-box-left">
		...
		<h4><strong><?php esc_attr_e( "Pop-up titles", Opt_In::TEXT_DOMAIN ); ?></strong></h4>
	...
	<div class="wpmudev-box-right">
		...
		<div class="wpmudev-switch-labeled">
			...
			<label class="wpmudev-switch-label" for="wph-popup-titles"><?php esc_attr_e( "Use titles", Opt_In::TEXT_DOMAIN ); ?></label>
