<div id="wph-wizard-design-style" class="wpmudev-box-content">
	...
	<div class="wpmudev-box-left">
		...
		<label class="wpmudev-helper"><?php esc_attr_e( "Choose a pre-made style for your Pop-up and further customize its appearance.", Opt_In::TEXT_DOMAIN ); ?></label>
	...
	<div class="wpmudev-box-right">
		...
		<div class="wpmudev-switch-labeled">
			...
			<div class="wpmudev-switch">
				...
				<input id="wph-popup-style_colors" class="toggle-checkbox" type="checkbox" data-attribute="customize_colors" {{_.checked(_.isTrue(customize_colors), true)}}>
