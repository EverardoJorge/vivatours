	...
	<div class="wpmudev-box-right">
		...
		<div class="wpmudev-switch-labeled">
			...
			<div class="wpmudev-switch">
				...
				<input id="wph-popup-success_message_closing" class="toggle-checkbox" type="checkbox" data-attribute="auto_close_success_message" {{_.checked(_.isTrue(auto_close_success_message), true)}} >

				<label class="wpmudev-switch-design" for="wph-popup-success_message_closing" aria-hidden="true"></label>

			</div>

			<label class="wpmudev-switch-label" for="wph-popup-success_message_closing"><?php esc_attr_e( "Automatically close success message", Opt_In::TEXT_DOMAIN ); ?></label>
