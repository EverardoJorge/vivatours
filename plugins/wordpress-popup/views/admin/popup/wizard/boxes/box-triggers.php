<div id="wph-wizard-settings-triggers" class="wpmudev-box-content">
	...
	<div class="wpmudev-box-left">
		...
		<h4><strong><?php esc_attr_e( "Pop-up triggers", Opt_In::TEXT_DOMAIN ); ?></strong></h4>

		<label class="wpmudev-helper"><?php esc_attr_e( "Pop-ups can be triggered after a certain amount of Time, when the user Scrolls past an element, on Click, if the user tries to Leave or if we detect AdBlock", Opt_In::TEXT_DOMAIN ); ?></label>
            ...
            <div class="wpmudev-tabs-content">
                ...
                <div id="wpmudev-display-trigger-time" class="wpmudev-tabs-content_item {{ ( 'time' === triggers.trigger ) ? 'current' : '' }}">
                    ...
                    <div class="wpmudev-switch-labeled">
                        ...
                        <div class="wpmudev-switch-labels">
                            ...
                            <label class="wpmudev-switch-label" for="wph-popup-trigger_time"><?php esc_attr_e( "Show after certain time", Opt_In::TEXT_DOMAIN ); ?></label>

                            <label class="wpmudev-helper"><?php esc_attr_e( "If switched off, pop-up will be shown as soon as page is loaded.", Opt_In::TEXT_DOMAIN ); ?></label>
                    ...
                    <div id="wpmudev-display-trigger-time-options" class="wpmudev-box-gray {{ ( _.isTrue(triggers.on_time) ) ? 'wpmudev-show' : 'wpmudev-hidden' }}">
                        ...
                        <label><?php esc_attr_e( "Show pop-up after", Opt_In::TEXT_DOMAIN ); ?></label>
                ...
                <div id="wpmudev-display-trigger-scroll" class="wpmudev-tabs-content_item {{ ( 'scroll' === triggers.trigger ) ? 'current' : '' }}">
                    ...
                    <div id="wpmudev-display-trigger-scroll-options" class="wpmudev-box-gray">
                            ...
                            <label class="{{ ( 'scrolled' !== triggers.on_scroll ) ? 'wpmudev-hidden' : 'wpmudev-show' }}"><?php esc_attr_e( "Show pop-up after page has been scrolled", Opt_In::TEXT_DOMAIN ); ?></label>

                            <label class="{{ ( 'selector' !== triggers.on_scroll ) ? 'wpmudev-hidden' : 'wpmudev-show' }}"><?php esc_attr_e( "Show pop-up after user passed a CSS selector", Opt_In::TEXT_DOMAIN ); ?></label>
                ...
                <div id="wpmudev-display-trigger-click" class="wpmudev-tabs-content_item {{ ( 'click' === triggers.trigger ) ? 'current' : '' }}">
                    ...
                    <input type="text" value="[wd_hustle id='{{shortcode_id}}' type='popup']Click here[/wd_hustle]" class="wpmudev-shortcode" readonly="readonly" />
                ...
                <div id="wpmudev-display-trigger-exit_intent" class="wpmudev-tabs-content_item {{ ( 'exit_intent' === triggers.trigger ) ? 'current' : '' }}">
                    ...
                    <div class="wpmudev-switch-labeled">
                        ...
                        <label class="wpmudev-switch-label" for="wph-popup-trigger_session"><?php esc_attr_e( "Trigger once per session only", Opt_In::TEXT_DOMAIN ); ?></label>
					...
					<div class="wpmudev-switch-labeled">
                        ...
                        <div class="wpmudev-switch-labels">
                            ...
                            <label class="wpmudev-switch-label" for="wph-popup-on_exit_intent_delayed"><?php esc_attr_e( "Add delay", Opt_In::TEXT_DOMAIN ); ?></label>
                ...
                <div id="wpmudev-display-trigger-adblock" class="wpmudev-tabs-content_item {{ ( 'adblock' === triggers.trigger ) ? 'current' : '' }}">
                    ...
                    <div class="wpmudev-switch-labeled">
                        ...
                        <label class="wpmudev-switch-label" for="wph-popup-trigger_adblock"><?php esc_attr_e( "Trigger when AdBlock is detected", Opt_In::TEXT_DOMAIN ); ?></label>
