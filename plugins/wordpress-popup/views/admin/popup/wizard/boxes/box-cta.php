	...
	<div class="wpmudev-box-right">
		...
		<div class="wpmudev-switch-labeled">
			...
			<div class="wpmudev-switch">
				...
				<input id="wph-popup-cta-button" class="toggle-checkbox" type="checkbox" data-attribute="show_cta" {{_.checked(_.isTrue(show_cta), true)}}>

				<label class="wpmudev-switch-design" for="wph-popup-cta-button" aria-hidden="true"></label>
