		...
		<div id="wph-welcome" class="wpmudev-box wpmudev-box-close" data-nonce="<?php echo esc_attr( wp_create_nonce('hustle_new_welcome_notice') ); ?>">
			...
			<div class="wpmudev-box-body wpmudev-box-hero">
				...
				<div class="wpmudev-box-content">
					...
					<ul>
						<li><?php esc_attr_e( "Email opt ins – perfect for collecting your visitors' email addresses.", Opt_In::TEXT_DOMAIN ); ?></li>
						<li><?php esc_attr_e( "Custom Content – create any kind of pop-up, slide-in, widget or shortcode. e.g. An Ad.", Opt_In::TEXT_DOMAIN ); ?></li>
					</ul>
