<div id="wph-wizard-design-size" class="wpmudev-box-content">
	...
	<div class="wpmudev-box-left">
		...
		<h4><strong><?php esc_attr_e( "Custom slide-in size", Opt_In::TEXT_DOMAIN ); ?></strong></h4>
	...
	<div class="wpmudev-box-right">
		...
		<div class="wpmudev-switch-labeled">
			...
			<label class="wpmudev-switch-label" for="wph-slidein-custom_size"><?php esc_attr_e( "Use custom size", Opt_In::TEXT_DOMAIN ); ?></label>
