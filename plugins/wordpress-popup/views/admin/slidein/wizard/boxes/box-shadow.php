	...
	<div class="wpmudev-box-right">
		...
		<div class="wpmudev-switch-labeled">
			...
			<div class="wpmudev-switch">
				...
				<input id="wph-slidein-shadow" class="toggle-checkbox" type="checkbox" data-attribute="drop_shadow" {{_.checked(_.isTrue(drop_shadow), true)}}>

				<label class="wpmudev-switch-design" for="wph-slidein-shadow" aria-hidden="true"></label>

			</div>

			<label class="wpmudev-switch-label" for="wph-slidein-shadow"><?php esc_attr_e( "Show drop shadow", Opt_In::TEXT_DOMAIN ); ?></label>
		...
		<div id="wph-wizard-design-shadow-options" class="wpmudev-box-gray {{ ( _.isTrue(drop_shadow) ) ? 'wpmudev-show' : 'wpmudev-hidden' }}">
			...
			<div class="wpmudev-row">
				...
				<div class="wpmudev-col">
					...
					<div class="wpmudev-picker"><input id="slidein_modal_shadow" class="wpmudev-color_picker" type="text"  value="{{drop_shadow_color}}" data-attribute="drop_shadow_color" data-alpha="true" /></div>
