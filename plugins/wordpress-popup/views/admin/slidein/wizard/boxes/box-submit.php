<div id="wph-wizard-settings-submit" class="wpmudev-box-content last">
	...
	<div class="wpmudev-box-left">
        ...
        <label class="wpmudev-info"><?php esc_attr_e( "If your Slide-in contains a form, you can change the on submit behavior here.", Opt_In::TEXT_DOMAIN ); ?></label>
	...
	<div class="wpmudev-box-right">
        ...
        <select class="wpmudev-select" data-attribute="on_submit">
            <option value="close" {{ ( 'close' === on_submit ) ? 'selected' : '' }} ><?php esc_attr_e( "Close the Slide-in", Opt_In::TEXT_DOMAIN ); ?></option>
