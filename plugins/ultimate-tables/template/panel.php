...
.horizontalitemfull<?php echo $id; ?> {
    ...
    background: white;
    border: none;
    box-shadow: 0px -2px 18px 0px rgba(65, 77, 86, 0.25);
    border-radius: 6px;
...
<div class="horizontalitemfull<?php echo $id; ?> tablespanel"> 
	<form method="post" action="">
		<fieldset>
<label ><strong>Title: </strong></label><input id="stitle<?php echo $id; ?>" name="stitle<?php echo $id; ?>" placeholder="Table identifier" type="text" value="<?php echo $title; ?>" />
              <hr />
...
<label><strong>Table class: </strong></label>     
                   ...
                   <label><strong>Manual class: </strong></label> <input type='text' id='op4<?php echo $id; ?>'  name='op4<?php echo $id; ?>'  value='<?php echo $op4; ?>' >        
              Type or select a predefined class of "ultimate-tables.css".<br/>
              
              
              
              <label><strong>Max Height: </strong></label><input id="theight<?php echo $id; ?>" name="theight<?php echo $id; ?>" type="text" value="<?php echo $theight; ?>" /> Blank value predetermined height || 
              ...
              <br/>
                   ...
                   <label><strong>Pagination</strong></label>
      ...
      <h3>Table values:</h3>
      <p>How many colums and rows you want? Insert it and save changes.</p>
      <center>
