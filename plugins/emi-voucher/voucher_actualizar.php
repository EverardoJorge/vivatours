...
$query_insertar_voucher =  mysql_query("UPDATE vvt_voucher SET
...
if ($_POST[accion]=="cancelar") {
	$query_cancelar_voucher = mysql_query("UPDATE vvt_voucher SET folio='CANCELADO' WHERE idvoucher = ".$_POST[folio]."",$db)or die ($query_cancelar_voucher.mysql_error());
	//$mysql->insert($query_insertar_voucher);
}

if ($_POST[accion]=="duplicar") {

	$query_insert = mysql_query("insert into vvt_voucher select 0, folio, codigo1, codigo2, codigo3, codigo4, codigo5, codigo6, codigo7, codigo8, 
	codigo9, codigo10, codigo11, codigo12, codigo13,
	fechas, fechas2, fechas3, fechas4, fechas5, fechas6, fechas7, fechas8,
	descripciones, descripciones2, descripciones3, descripciones4, descripciones5, descripciones6,
	descripciones7, descripciones8, codigo14, codigo15
	 from vvt_voucher WHERE idvoucher = ".$_POST[folio]."",$db)or die ($query_insert.mysql_error());
    ...
    $url="https://www.viajesvivatours.com/wp-content/plugins/emi-voucher/consultapdf.php?folio=".$folio_Nuevo;
...
location.href="<?=$_POST[URLretorno]?>"
</script>