 ...
 */
 ...
 if(!isset($_pagi_nav_anterior)){
	...
	$_pagi_nav_anterior = "<img src='images/previous.png' alt='Anterior' width='20' height='12' border='0'/>";
 } 
 
 if(!isset($_pagi_nav_siguiente)){
	// Si no se ha elegido una cadena para el enlace "siguiente"
	// Se toma la cadena por defecto.
	$_pagi_nav_siguiente = "<img src='images/next.png' alt='Siguiente' width='20' height='12'border='0' />";
 } 

 if(!isset($_pagi_nav_primera)){
	// Si no se ha elegido una cadena para el enlace "primera"
	// Se toma la cadena por defecto.
	$_pagi_nav_primera = "<img src='images/first.png' alt='Primera' width='20' height='12' border='0'/>";
 } 
 
 if(!isset($_pagi_nav_ultima)){
	// Si no se ha elegido una cadena para el enlace "siguiente"
	// Se toma la cadena por defecto.
	$_pagi_nav_ultima = "<img src='images/last.png' alt='Ultima' width='20' height='12' border='0' />";
 } 
 ...
 */
 ...
 if ($_pagi_actual != 1){
    ...
    <a ".$_pagi_nav_estilo_mod." aria-label='Previous' href='".$_pagi_enlace."_pagi_pg=".$_pagi_url."'>$_pagi_nav_primera</a>
   ...
   ";
	...
	<a ".$_pagi_nav_estilo_mod." href='".$_pagi_enlace."_pagi_pg=".$_pagi_url."'  aria-label='Previous'></a> <span aria-hidden='true'>$_pagi_nav_anterior</span>
    ";
 }
 ...
 if ($_pagi_actual < $_pagi_totalPags){
	...
	$_pagi_url = $_pagi_actual + 1; //será el número de página al que enlazamos
	$_pagi_navegacion_temporal[] = "
	 <a ".$_pagi_nav_estilo_mod." href='".$_pagi_enlace."_pagi_pg=".$_pagi_url."' aria-label='Next'></a>
	 <span aria-hidden='true'>$_pagi_nav_siguiente</span>
	...
	$_pagi_navegacion_temporal[] = "<a ".$_pagi_nav_estilo_mod." href='".$_pagi_enlace."_pagi_pg=".$_pagi_url."' aria-label='Next'></a> <span aria-hidden='true'>$_pagi_nav_ultima</span>";
 }
