...
$query = $wpdb->get_results("SELECT * FROM wp_voucher", ARRAY_A);
//$_pagi_result = $wpdb->get_results( "SELECT * FROM wp_voucher");
//$_pagi_result = mysqli_query($link, "SELECT * FROM wp_voucher");
