...
$db=conectar();
    //registro el baucher
$query_insertar_voucher = mysql_query("INSERT INTO vvt_voucher_recep (folio, codigo1,codigo2,codigo3,codigo4,codigo5,codigo6,codigo7,codigo8,codigo9,codigo10,codigo11,codigo12,codigo13,fechas,fechas2,fechas3,fechas4,fechas5,fechas6,fechas7,fechas8,descripciones,descripciones2,descripciones3,descripciones4,descripciones5,descripciones6,descripciones7,descripciones8, codigo14, codigo15)
									VALUES
('', 
'".addslashes($_POST['codigo1'])."',
'".addslashes($_POST['codigo2'])."', 
'".addslashes($_POST['codigo3'])."', 
'".addslashes($_POST['codigo4'])."', 
'".addslashes($_POST['codigo5'])."', 
'".addslashes($_POST['codigo6'])."', 
'".addslashes($_POST['codigo7'])."', 
'".addslashes($_POST['codigo8'])."', 
'".addslashes($_POST['codigo9'])."', 
'".addslashes($_POST['codigo10'])."', 
'".addslashes($_POST['codigo11'])."', 
'".addslashes($_POST['codigo12'])."', 
'".addslashes($_POST['codigo13'])."', 
'".addslashes($_POST['fechas'])."', 
'".addslashes($_POST['fechas2'])."',
'".addslashes($_POST['fechas3'])."', 
'".addslashes($_POST['fechas4'])."', 
'".addslashes($_POST['fechas5'])."', 
'".addslashes($_POST['fechas6'])."', 
'".addslashes($_POST['fechas7'])."', 
'".addslashes($_POST['fechas8'])."', 
'".addslashes($_POST['descripciones'])."', 
'".addslashes($_POST['descripciones2'])."', 
'".addslashes($_POST['descripciones3'])."',
 '".addslashes($_POST['descripciones4'])."',
  '".addslashes($_POST['descripciones5'])."',
   '".addslashes($_POST['descripciones6'])."',
    '".addslashes($_POST['descripciones7'])."', 
	'".addslashes($_POST['descripciones8'])."', 
	'".addslashes($_POST['codigo14'])."', 
	'".addslashes($_POST['codigo15'])."')",$db)or die ($query_insertar_voucher.mysql_error());
	$rs = mysql_query("SELECT @@identity AS id",$db);
    $row = mysql_fetch_row($rs); 
    $folio = trim($row[0]);
 
 require('qrcode/phpqrcode.php');
 $url="https://viajesvivatours.com/wp-content/plugins/recep-voucher/consultapdf.php?folio=".$folio."";
 QRcode::png($url, "qrcode/".$folio.".png",'Q',2,0); 
	  
if ($_POST[accion]=="todo") {
$html = '
...
<form id="form1" name="form1" method="post" action="">
  ...
  <table width="800" border="0" align="center" cellpadding="0" cellspacing="0">
    ...
    </table>    <table width="220px" border="1" align="left" cellpadding="0" cellspacing="0"  rules="none" style="text-align:center; vertical-align:middle;">
      <tr>
        <td width="197px" class="titulos_voucher">SELLO Y FIRMA / STAMP AND SIGNATURE</td>
        </tr>
      <tr>
        <td height="80px" style="padding-left:4px">
    ...
    <tr>
      <td colspan="2" valign="top">    
        <table width="569px" border="1"  style="border:1px #999999 solid;" cellspacing="0" cellpadding="1"  rules="none">
          <tr>
