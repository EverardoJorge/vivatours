...
function EWD_FEUP_Output_Options() {
		...
		if ($_GET['Action'] == "EWD_FEUP_User_Details" and isset($_GET['User_ID']))  {include( plugin_dir_path( __FILE__ ) . '../html/UserDetails.php');}
		elseif ($_GET['Action'] == "EWD_FEUP_User_Details")  {include( plugin_dir_path( __FILE__ ) . '../html/AddUser.php');}
