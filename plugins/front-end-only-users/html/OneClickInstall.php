<?php
	function EWD_FEUP_One_Click_Install_Pages_List() {
		...
		echo "<option value='Edit Profile (Newly Created)'>" . __("Edit Profile", 'front-end-only-users') . " (" . __("Newly Created", 'front-end-only-users') . ")</option>";
		echo "<option value='Register (Newly Created)'>" . __("Register", 'front-end-only-users') . " (" . __("Newly Created", 'front-end-only-users') . ")</option>";
		echo "<option value='Login (Newly Created)'>" . __("Login", 'front-end-only-users') . " (" . __("Newly Created", 'front-end-only-users') . ")</option>";
		echo "<option value='Logout (Newly Created)'>" . __("Logout", 'front-end-only-users') . " (" . __("Newly Created", 'front-end-only-users') . ")</option>";
		echo "<option value='Forgot Password (Newly Created)'>" . __("Forgot Password", 'front-end-only-users') . " (" . __("Newly Created", 'front-end-only-users') . ")</option>";
		echo "<option value='Confirm Forgot Password (Newly Created)'>" . __("Confirm Forgot Password", 'front-end-only-users') . " (" . __("New", 'front-end-only-users') . ")</option>";
		echo "<option value='Change Password (Newly Created)'>" . __("Change Password", 'front-end-only-users') . " (" . __("Newly Created", 'front-end-only-users') . ")</option>";
		echo "<option value='Login Logout Toggle (Newly Created)'>" . __("Login-Logout Toggle", 'front-end-only-users') . " (" . __("Newly Created", 'front-end-only-users') . ")</option>";
		echo "<option value='User Profile (Newly Created)'>" . __("User Profile", 'front-end-only-users') . " (" . __("Newly Created", 'front-end-only-users') . ")</option>";
		echo "<option value='User Search (Newly Created)'>" . __("User Search", 'front-end-only-users') . " (" . __("Newly Created", 'front-end-only-users') . ")</option>";
		echo "<option value='User List (Newly Created)'>" . __("User List", 'front-end-only-users') . " (" . __("Newly Created", 'front-end-only-users') . ")</option>";
		echo "<option value='User Data (Newly Created)'>" . __("User Data", 'front-end-only-users') . " (" . __("Newly Created", 'front-end-only-users') . ")</option>";
	...
	$Page_Options[0]['Name'] = __("Edit Profile", 'front-end-only-users');
	...
	$Page_Options[1]['Name'] = __("Register", 'front-end-only-users');
	...
	$Page_Options[2]['Name'] = __("Login", 'front-end-only-users');
	...
	$Page_Options[3]['Name'] = __("Logout", 'front-end-only-users');
	...
	$Page_Options[4]['Name'] = __("Forgot Password", 'front-end-only-users');
	...
	$Page_Options[5]['Name'] = __("Confirm Forgotten Password", 'front-end-only-users');
	...
	$Page_Options[6]['Name'] = __("Change Password", 'front-end-only-users');
	...
	$Page_Options[7]['Name'] = __("Login-Logout Toggle (Optional)", 'front-end-only-users');
	...
	$Page_Options[8]['Name'] = __("User Profile (Optional)", 'front-end-only-users');
	...
	$Page_Options[9]['Name'] = __("User Search (Optional)", 'front-end-only-users');
	...
	$Page_Options[10]['Name'] = __("User List (Optional)", 'front-end-only-users');
	...
	$Page_Options[11]['Name'] = __("User Data (Optional)", 'front-end-only-users');
...
<form action='admin.php?page=EWD-FEUP-options&DisplayPage=Dashboard&Action=EWD_FEUP_OneClickInstall' method='post'>
	...
	<div class="ewd-feup-admin-section-heading"><?php _e('One Click Setup', 'front-end-only-users'); ?></div>
	
	<table class="form-table">
		<thead>
			<tr>
				<th class="ewd-feup-admin-no-info-button">
					Include?
				</th>
				<th class="ewd-feup-admin-no-info-button">
					Page Name
